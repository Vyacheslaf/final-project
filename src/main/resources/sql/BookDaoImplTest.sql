...
UPDATE book SET available=0 WHERE id=2;
INSERT INTO wishlist (user_id, book_id, state, create_time, return_time) VALUES (1, 2, 'processed', '2022-10-22 12:00:00', '2025-10-23 12:00:00');