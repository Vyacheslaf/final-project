...
/**
 * A servlet that processes the order and redirects the librarian to the reader details servlet.
...
public class OrderHandlerServlet extends HttpServlet {
	 ...
	 */
	private static final long serialVersionUID = 4422152388327618953L;

	/**
	 * The Log4j Logger
	 */
	private static final Logger LOG = LogManager.getLogger(OrderHandlerServlet.class);

	/**
	 * The {@code String} specifying the name of the attribute 
	 * to store the reader's ID from the processed order to the <code>HttpServletRequest</code>
	 */
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			new OrderService().giveOrder(req);
